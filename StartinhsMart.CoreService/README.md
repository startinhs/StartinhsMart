...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2083c9be-e033-4abc-a2e8-a862502d4375
```

> `2083c9be-e033-4abc-a2e8-a862502d4375` is the password of the certificate, you can change it to any password you want.
